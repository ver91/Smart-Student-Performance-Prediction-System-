...
tk.Entry(r, font=("Arial", 13), state="disabled").grid(row=0, column=1, sticky="ew",)
tk.Label(r, text="Risk Level:",font=("Arial", 13)).grid(row=1, column=0, padx=25, pady=15)
tk.Entry(r, font=("Arial", 13), state="disabled").grid(row=1, column=1, sticky="ew")
tk.Label(r, text="Recommendation:",font=("Arial", 13)).grid(row=2, column=0, padx=25, pady=15)
tk.Text(r, font=("Arial", 13), width=70, height=3, state="disabled").grid(row=2, column=1, sticky="nsew")
